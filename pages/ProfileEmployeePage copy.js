...
const ProfileRealtorPage = () => {
  ...
  const sections = [
    ...
    },
    {
      ...
      data: [
        // TODO: объявления компании, сейчас страница пользователя выводит только для пользователя
        {
          ...
          navigation: ["UserPostsPage", { user_id: userr.id, status: 1 }],
        },
        {
          icon: <Ionicons name="lock-closed-outline" size={20} color="black" />,
          label: "Закрытые объявления",
          navigation: ["UserPostsPage", { user_id: userr.id, status: 3 }],
        },
        {
    ...
    },
    {
      ...
      data: [
        {
          icon: <Ionicons name="settings-outline" size={17} color="black" />,
          label: "Настройки",
  ...
  return (
    ...
    >
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View
          style={{ marginLeft: 16, width: width - 32, alignItems: "center" }}
        >
        ...
        >
          ...
          >
            <Text style={[styles.itemText, { marginLeft: 0 }]}>Акции</Text>
            <View
              style={{
                backgroundColor: "red",
                alignItems: "center",
        ...
        >
          <Text style={styles.itemText}>Баланс</Text>
          <Text style={styles.itemText}>9222 руб</Text>
        </View>
