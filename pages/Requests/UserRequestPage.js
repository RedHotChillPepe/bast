...
const UserRequestPage = (props) => {
  ...
  const handleSelected = (item) => {
    ...
    setDataCurrentSelector(
      filteredDataForSelector(isDeal ? deals : requests, item)
    );
  };
  ...
  const renderStatus = (status) => {
    return (
      ...
      >
        <Text style={styles.flag__text}> {status.stage}</Text>
      </View>
    );
  };
            ...
            >
              <View style={{ flexDirection: "row" }}>
                ...
                <Text style={styles.update__date}>
                  {new Date(item.last_assign.assigned_at).toLocaleDateString(
                    "ru-RU",
                    {
                      day: "2-digit",
                      month: "2-digit",
      ...
      <View style={styles.container}>
        ...
        <View style={styles.containerScroll}>
          <Selectors
            ...
            listSelector={
              isDeal ? listSelectPropertiesDeal : listSelectPropertiesRequest
            }
          />
          {renderRequest()}
        </View>
