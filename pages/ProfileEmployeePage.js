  ...
  const sections = [
    {
      title: 'Основные',
      data: [
        { icon: <Ionicons name="document-outline" size={17} color="black" />, label: 'Текущие проекты', navigation: ['Error', { errorCode: 503 }] },
      ],
    },
    {
      title: 'Основные',
    ...
    },
    {
      title: 'Основные',
      data: [
        { icon: <Ionicons name="document-outline" size={17} color="black" />, label: 'Компания', navigation: ['Error', { errorCode: 503 }] },
        { icon: <Ionicons name="document-outline" size={17} color="black" />, label: 'Комнада', navigation: ['Error', { errorCode: 503 }] },
        { icon: <Ionicons name="document-outline" size={17} color="black" />, label: 'Контрагенты', navigation: ['Error', { errorCode: 503 }] },
      ],
    },
    {
      title: 'Основные',
      data: [
        { icon: <Ionicons name="document-outline" size={17} color="black" />, label: 'Клиенты', navigation: ['Error', { errorCode: 503 }] },
        { icon: <Ionicons name="document-outline" size={17} color="black" />, label: 'Сделки', navigation: ['Error', { errorCode: 503 }] },
      ],
    },
    {
      title: 'Мои действия',
      data: [
        ...
        { icon: <Ionicons name="man-outline" size={17} color="black" />, label: 'Риэлторы', navigation: ['Error', { errorCode: 503 }] },
      ],
    },
    {
