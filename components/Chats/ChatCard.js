...
export default function ChatCard({ post, lastMessage = "", searchValue, isModal = false, initials, isPined = false }) {
            ...
            <View style={styles.postContainer}>
                ...
                <View style={styles.post__info}>
                    ...
                    <View style={[styles.post__caption, { flexDirection: isModal ? "column" : "row", alignItems: isModal ? "baseline" : "center" }]}>
                        ...
                        {!isModal && <DotIcon />}
                        <Text style={styles.caption__text}>{Number(post.price).toLocaleString('ru-RU')} ₽</Text>
                    </View>
